...
2. Added Array Random Generation By Default   
...
## **Changelog/Commit 02**
  ...
  ```
  3.  How To Increase And Decrease timer Timer ! Just Change The Timer Variable's Value 
  ```dart
      int timer = 30;
  ```
...
1. Disabled Multiple Button Pressed After Answering
